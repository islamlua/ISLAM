...
📟¦ مـن مشكلجية  وآلتوجيهہ‌‏ وآلتگرآر وآلتقيد
...
local inline = {{{text="قنآهہ‏‏ آلسـورس : الـزعـيـم 🍃",url="t.me/@ZOZOIIK4"}}}
return send_inline_key(msg.from.id,'  [قناة السورس : مشكلجية](t.me/@ZOZOIIK4)',nil,inline)
end
